...
Revision ID: 7a046b862743
Revises: 
Create Date: 2023-05-29 01:06:13.681877
...
def upgrade():
    ...
    sa.CheckConstraint('invested_amount <= full_amount', name='check_invested_amount_not_exceed_full_amount'),
